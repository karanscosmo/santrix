    ...
    <div className="bg-[#050505] text-[#e5e2e1] font-sans antialiased overflow-x-hidden min-h-screen selection:bg-primary/30 selection:text-white flex flex-col relative">
      ...
      <header className="fixed top-0 w-full z-[100] bg-surface-container-lowest/70 backdrop-blur-xl border-b border-outline-variant/10 shadow-[0_0_40px_rgba(0,219,231,0.05)]">
        <div className="flex justify-between items-center px-margin-desktop py-4 max-w-[1440px] mx-auto w-full">
          ...
          <div className="hidden md:flex gap-8">
            <a
              className="text-primary font-semibold border-b-2 border-primary pb-1 font-body-md text-body-md transition-all duration-300"
              href="#loop"
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-24 overflow-hidden" id="hero">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto space-y-8 flex flex-col items-center">
          ...
          <div className="relative w-72 h-24 sm:w-[480px] sm:h-[150px] overflow-hidden border border-white/10 rounded-2xl bg-black/60 p-2 shadow-[0_0_30px_rgba(86,141,255,0.1)] hover:border-primary/30 transition-all duration-500">
            <img
              src="/Santrix_logo.jpeg"
      ...
      <section className="py-32 px-margin-desktop bg-surface-container-lowest" id="loop">
      ...
      <section className="py-32 px-margin-desktop bg-surface-container-lowest">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Finance Agent */}
            <div className="glass-panel p-10 space-y-6 hover:-translate-y-2 transition-all duration-300 group">
            ...
            {/* Wolfram Agent */}
            <div className="glass-panel p-10 space-y-6 hover:-translate-y-2 transition-all duration-300 group border-secondary-fixed-dim/30">
      ...
      {/* SECTION 6: SIMULATION PLAYGROUND */}
      <section className="py-32 px-margin-desktop bg-background">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <button
              onClick={() => router.push("/login")}
              className="glass-panel p-8 text-left hover:bg-surface-container-high transition-all border-l-4 border-l-primary cursor-pointer"
            >
            ...
            <button
              onClick={() => router.push("/login")}
              className="glass-panel p-8 text-left hover:bg-surface-container-high transition-all border-l-4 border-l-secondary-fixed-dim cursor-pointer"
            >
            ...
            <button
              onClick={() => router.push("/login")}
              className="glass-panel p-8 text-left hover:bg-surface-container-high transition-all border-l-4 border-l-tertiary-fixed-dim cursor-pointer"
            >
            ...
            <button
              onClick={() => router.push("/login")}
              className="glass-panel p-8 text-left hover:bg-surface-container-high transition-all border-l-4 border-l-error cursor-pointer"
            >
      ...
      <section className="py-32 px-margin-desktop bg-surface-container-lowest overflow-hidden" id="architecture">
        <div className="max-w-[1440px] mx-auto text-center space-y-16">
          ...
          <div className="relative h-[600px] w-full glass-panel rounded-3xl overflow-hidden border-primary/20">
            ...
            {/* UI Overlays */}
            <div className="absolute top-8 left-8 p-6 glass-panel border-l-4 border-l-primary text-left max-w-xs">
            ...
            <div className="absolute bottom-8 right-8 p-6 glass-panel border-l-4 border-l-error text-left max-w-xs">
      ...
      <section className="py-32 px-margin-desktop bg-background">
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          <div className="glass-panel font-code-sm text-code-sm overflow-hidden flex flex-col h-[400px]">
      ...
      <section className="py-32 px-margin-desktop bg-background">
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="glass-panel overflow-hidden border-outline-variant/10">
      ...
      <section className="py-40 px-margin-desktop relative overflow-hidden bg-background text-center">
        ...
        <div className="max-w-4xl mx-auto space-y-12 relative z-10 flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <button
              onClick={() => router.push("/login")}
              className="px-12 py-5 bg-primary text-on-primary font-bold text-xl hover:scale-105 transition-all duration-300 cursor-pointer"
            >
              Launch Platform
            </button>
            <button
              onClick={() => router.push("/demo")}
              className="px-12 py-5 border border-outline-variant hover:bg-surface-bright/10 font-bold text-xl transition-all duration-300 cursor-pointer"
            >
              Run Demo Scenario
            </button>
            <button
